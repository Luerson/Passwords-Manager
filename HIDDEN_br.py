    ...
    if not username:
        ...
        if not valid_email_format(email):
            ...
            if send_email(EMAIL, title, message):
                received = messagebox.askyesno("código enviado", "um código de verificação foi enviado para seu "
                                                                 "endereço de email, por favor confirme se o recebeu"
                                                                 "( Talvez demore um pouco para chegar).")
